...
export default function Home() {
  ...
  return (
    <main className="app-shell">
      ...
      {profileModalOpen && (
        <>
          {/* Backdrop: coral, immer fixed — kein transform, kein iOS-Flackern */}
          <div className="fixed inset-0 z-50" style={{ background: "var(--coral)" }} />
          {/* Content: slidet, kein overflow darauf */}
          <div
            className={`fixed inset-0 z-50 ${profileModalClosing ? "modal-exit" : "modal-enter"}`}
          >
            {/* Scroll-Container als Kind — trennt translate von overflow */}
            <div className="h-full overflow-y-auto" style={{ background: "var(--coral)" }}>
