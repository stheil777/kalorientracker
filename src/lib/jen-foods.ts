...
export const JEN_FOODS: FoodResult[] = [
  ...
  { id: "jen-eier", name: "Eier", per100g: { calories: 155, protein: 13, carbs: 1, fat: 11 }, source: "jen" },
  ...
  // Obst
  { id: "jen-banane", name: "Banane", per100g: { calories: 89, protein: 1, carbs: 23, fat: 0 }, source: "jen" },
  { id: "jen-apfel", name: "Apfel", per100g: { calories: 52, protein: 0, carbs: 14, fat: 0 }, source: "jen" },
  ...
  { id: "jen-pfirsich", name: "Pfirsich", per100g: { calories: 39, protein: 1, carbs: 10, fat: 0 }, source: "jen" },
  { id: "jen-papaya", name: "Papaya", per100g: { calories: 43, protein: 1, carbs: 11, fat: 0 }, source: "jen" },
  { id: "jen-mango", name: "Mango", per100g: { calories: 60, protein: 1, carbs: 15, fat: 0 }, source: "jen" },
  { id: "jen-kiwi", name: "Kiwi", per100g: { calories: 61, protein: 1, carbs: 15, fat: 1 }, source: "jen" },
  { id: "jen-orange", name: "Orange", per100g: { calories: 47, protein: 1, carbs: 12, fat: 0 }, source: "jen" },
  { id: "jen-ananas", name: "Ananas", per100g: { calories: 50, protein: 1, carbs: 13, fat: 0 }, source: "jen" },
  { id: "jen-wassermelone", name: "Wassermelone", per100g: { calories: 30, protein: 1, carbs: 8, fat: 0 }, source: "jen" },
  { id: "jen-grapefruit", name: "Grapefruit", per100g: { calories: 42, protein: 1, carbs: 11, fat: 0 }, source: "jen" },
  { id: "jen-zitrone", name: "Zitrone", per100g: { calories: 29, protein: 1, carbs: 9, fat: 0 }, source: "jen" },
  { id: "jen-limette", name: "Limette", per100g: { calories: 30, protein: 1, carbs: 11, fat: 0 }, source: "jen" },
