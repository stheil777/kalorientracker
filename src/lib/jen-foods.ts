...
export const JEN_FOODS: FoodResult[] = [
  ...
  { id: "jen-erbsenmilch", name: "Erbsenmilch", per100g: { calories: 29, protein: 3, carbs: 0, fat: 2 }, measure_unit: "ml", portions: [{ label: "Glas", amount: 250 }], source: "jen" },
  { id: "jen-feta", name: "Feta-Käse", per100g: { calories: 264, protein: 14, carbs: 4, fat: 21 }, source: "jen" },
  { id: "jen-hafermilch", name: "Hafermilch", per100g: { calories: 48, protein: 1, carbs: 5, fat: 3 }, measure_unit: "ml", portions: [{ label: "Glas", amount: 250 }], source: "jen" },
  ...
  { id: "jen-kokosmilch-drink", name: "Kokosmilch (Drink)", per100g: { calories: 25, protein: 0, carbs: 0, fat: 2 }, measure_unit: "ml", portions: [{ label: "Glas", amount: 250 }], source: "jen" },
  { id: "jen-kuhmilch", name: "Kuhmilch", per100g: { calories: 64, protein: 3, carbs: 5, fat: 4 }, measure_unit: "ml", portions: [{ label: "Glas", amount: 250 }], source: "jen" },
  { id: "jen-magerquark", name: "Magerquark", per100g: { calories: 67, protein: 12, carbs: 4, fat: 0 }, source: "jen" },
  { id: "jen-mandelmilch", name: "Mandelmilch", per100g: { calories: 15, protein: 1, carbs: 0, fat: 1 }, measure_unit: "ml", portions: [{ label: "Glas", amount: 250 }], source: "jen" },
  { id: "jen-nussmilch", name: "Nussmilch", per100g: { calories: 17, protein: 0, carbs: 1, fat: 1 }, measure_unit: "ml", portions: [{ label: "Glas", amount: 250 }], source: "jen" },
  { id: "jen-reismilch", name: "Reismilch", per100g: { calories: 47, protein: 0, carbs: 9, fat: 1 }, measure_unit: "ml", portions: [{ label: "Glas", amount: 250 }], source: "jen" },
  ...
  { id: "jen-pasta", name: "Nudeln / Pasta (gekocht)", per100g: { calories: 158, protein: 6, carbs: 31, fat: 1 }, source: "jen" },
  ...
  { id: "jen-paranuesse", name: "Paranüsse", per100g: { calories: 659, protein: 14, carbs: 12, fat: 67 }, stueck_g: 5, source: "jen" },
  { id: "jen-pekannuesse", name: "Pekannüsse", per100g: { calories: 691, protein: 9, carbs: 14, fat: 72 }, source: "jen" },
  { id: "jen-walnuesse", name: "Walnüsse", per100g: { calories: 654, protein: 15, carbs: 14, fat: 65 }, source: "jen" },
  ...
  { id: "jen-kaffee", name: "Kaffee (schwarz)", per100g: { calories: 2, protein: 0, carbs: 0, fat: 0 }, measure_unit: "ml", portions: [{ label: "Tasse", amount: 200 }], source: "jen" },
  { id: "jen-ketchup", name: "Ketchup", per100g: { calories: 112, protein: 2, carbs: 27, fat: 0 }, source: "jen" },
  { id: "jen-pizza", name: "Pizza (Durchschnitt)", per100g: { calories: 280, protein: 12, carbs: 30, fat: 13 }, portions: [{ label: "Stück", amount: 125 }], source: "jen" },
  { id: "jen-schokolade", name: "Schokolade 85%", per100g: { calories: 570, protein: 7, carbs: 30, fat: 43 }, source: "jen" },
  { id: "jen-schokolade-vollmilch", name: "Schokolade Vollmilch", per100g: { calories: 535, protein: 8, carbs: 59, fat: 30 }, source: "jen" },
  { id: "jen-schokolade-zartbitter", name: "Schokolade Zartbitter (70%)", per100g: { calories: 598, protein: 8, carbs: 46, fat: 43 }, source: "jen" },
  ...
  { id: "jen-suppe-gemuese", name: "Suppe (Gemüsesuppe)", per100g: { calories: 51, protein: 2, carbs: 10, fat: 0 }, source: "jen" },
  { id: "jen-suessigkeiten-gummibaerchen", name: "Süßigkeiten (Gummibärchen)", per100g: { calories: 396, protein: 0, carbs: 99, fat: 0 }, source: "jen" },
